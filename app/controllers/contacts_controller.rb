...
# module. It provides generic methods to manipulate the polymorphic Contact model.
class ContactsController < ApplicationController

  protected

  # Adds a contact to a model, that has a _has_one_ association to the Contact model.
  # It uses the _params_ hash to determine the contact field and the contact value.
  #
  ...
  # Removes a contact from a field. It behaves like ContactsController#add_to(),
  # but vice versa.
